 ...
 * Space Grotesk — modern geometric sans-serif for headlines and display text
 *
 * Note: For custom fonts, you'll need to:
 * 1. Install via: pnpm add @expo-google-fonts/space-grotesk (or other)
...
export const fontFamily = {
  ...
  primaryBold: 'SpaceGrotesk-Bold',
  primaryMedium: 'SpaceGrotesk-Medium',
  primarySemiBold: 'SpaceGrotesk-SemiBold',
