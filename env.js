 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.driveapp.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.xdriveapp.drive'; // ios bundle id
const PACKAGE = 'com.xdriveapp'; // android package name
const NAME = 'DRIVE'; // app name
const EXPO_ACCOUNT_OWNER = 'eohlde'; // expo account owner
const EAS_PROJECT_ID = '62ed1810-f58b-4075-961f-63f934b3cfaa'; // eas project id
const SCHEME = 'DRIVEApp'; // app scheme
